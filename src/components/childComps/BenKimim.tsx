    ...
    <section className="flex md:px-[150px] pb-[100px]">
      <div className="flex flex-col px-10  items-center">
        ...
        <p className="">
          ...
          Üniversitesinde Yönetim Bilişim Sistemleri eğitimi almaktayım. 2 yılı
          aşkın bir süredir yazılım alanında kendimi durmadan eğitiyor, günlük
          sorunlarımı çözen ve üretme açlığımı dindiren projeler geliştiriyorum.
          Teknolojiler kısmında şuanda bildiğim ve kullandığım dilleri
          (frameworkleri) görebilirsiniz. Orada gördüklerinizin dışında
          Typescript ve Jest teknolojilerini öğrenmekte oldukça hevesliyim.
          Önceki çalıştığım şirketlerdeki çalışma arkadaşlarımla İngilizce
          iletişim kurmamıza rağmen ortaya harika bir takım çalışması
          koyabiliyorduk.
          <br />
          <br />
