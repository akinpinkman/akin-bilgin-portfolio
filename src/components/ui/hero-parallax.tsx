...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[213vh] min-[600px]:h-[220vh] min-[600px]:h-[235vh] md:h-[220vh] pt-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-3xl min-[500px]:text-5xl min-[600px]:text-6xl md:text-7xl font-bold dark:text-white">
        Akın Bilgin <br />
        <span className="magic">
          ...
          <span className="magic-text">Frontend Developer</span>
        </span>
      </h1>
